...
namespace Praktek_7._5_kalkulator
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                Console.Clear(); // Membersihkan layar konsol untuk setiaap perhitungan baru
                Console.WriteLine("--- KALKULATORR SEDERHANA---");
                ...
                //dan memastikan input adalah angka valid
                if (AmbilInputAngka(out angka1, out angka2))
                {
                    ...
                    switch (pilihan)
                    {
                        ...
                        case "4": //Pembagian
                            ...
                            if (angka2 == 0)
                            {
                                Console.WriteLine("\nError; Tidak dapat melakukan pembagia dengan nol.");
                            }
                            else
                            {
                            ...
                            break;
                        default: // Jika piliha tidak ada di case 1-4
                ...
                // ToLower() membuat input menjadi huruf kecil, 'Y' atau 'y' akan sama
        ...
        //Fungsi untuk menampilkan menu piihan
        ...
        //Fungsi untuk mengambil input angka dari pengguma
        ...
        static bool AmbilInputAngka(out double angka1, out double angka2)
        {
            ...
            // double.TryPaste akan mencoba mengkonversi string ke double.
            ...
            {
                Console.WriteLine("Inpuut untuk angka pertama tidak valid");
